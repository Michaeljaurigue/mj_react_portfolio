  ...
  return (
    <div className="about-container">
      ...
      <div className="about__item-info">
        ...
        <p>
          Seeking a Software Engineer role, eager to apply my skills and
          knowledge toward building innovative solutions. Currently enrolled at
        ...
        <p>
          I strongly believe that technology can bring people together, and it
          has the power to make a positive impact on humanity. ❤️
        </p>
        <p>
          My desire to contribute to this cause motivates me to pursue a career
          in tech. Through my work, I aspire to leverage technology to help
          build innovative solutions that address pressing societal needs,
